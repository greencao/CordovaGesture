...
//				}).start();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLockPattern = new LockPattern(RestartActivity.this, Lisence);
		...
		mGestureContentView = new GestureContentView(RestartActivity.this,
			...
			//加密值ֵ
					...
					public void onGestureCodeInputHash(String inputCodeHash) {
						...
						}else if (strEncryption.equals(inputCodeHash)) {
							ISbinggo=true;		
							text_Title.setText("请设置新的手势密码");
							mGestureContentView.clearDrawlineState(0L);
							}else if (!(strEncryption.equals(inputCodeHash))) {
								ISbinggo=false;		
								text_Title.setText("请输入正确的手势密码");
								mGestureContentView.clearDrawlineState(2000L);
							}
...
//			}
//		});
		 if (strEncryption.equals("")) {
				Toast.makeText(RestartActivity.this, "还未设置手势密码，请直接设置手势密码", 5).show();		
				ISbinggo=true;
				text_Title.setText("请设置手势密码");
				mGestureContentView.clearDrawlineState(0L);
			}
